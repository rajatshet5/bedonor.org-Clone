...
export function Navbar({tempo, load, changeLoad, altShow, altShowFn }) {
    ...
    return <div className={styles.navbar}>
        ...
        <div className={styles.imgDiv}>
            <NavLink to='/'><img style={{cursor:'pointer'}} src="https://sytb5eeu.cdn.imgeng.in/logo.svg" alt="logo"/></NavLink>
        </div>
        <div>
            ...
            <div className={styles.btnDiv}>
                <button className={styles.bns}><NavLink style={{ textDecoration: 'none' }} to='/fundraiser'>Be Donor</NavLink></button>
                <button className={styles.chat}><img src="https://sytb5eeu.cdn.imgeng.in/img/whastapp-icon.png"/><p>Chat</p></button>
